...
include "$doc_root/modules/autorize.php";
$userdata =  currentUserData(false);
...
$config['licenseName'] = 'www.itstart.su';
$config['licenseKey']  = 'VJ?L-M1lf-6NNN-L7TY-QWHY-UPRP-5UYK';//Крякнул
